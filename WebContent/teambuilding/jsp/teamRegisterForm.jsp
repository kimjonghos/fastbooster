	...
	<div class="col-xs-6 team_regist_form_layout">
		<div class="row team_regist_whole">
			<div class="row team_regist_form_title">
				<label class="team_regist_text_title team_regist_text_blue">팀 등록</label>
			</div>
			...
			<form id="registForm" action="./teamRegister.do" method="post"
						...
						<div class="modal-dialog modal-lg">
							...
							<div class="modal-content">
								...
								<div class="modal-body" style="font-size: 25px;">
									...
									<div class="row">
										<button type="button" class="btn btn-mid team_regist_btn_color"
											data-dismiss="modal"
					...
					<div class="modal" id="myModal2" style="font-size: 25px;">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="row">
										<div class="col" style="margin-left: 20px;">
											<input class="form-check-input" type="checkbox" name="role_id" value="role-1">기획자
										</div>
										<div class="col" style="margin-left: 20px;">
											<input name="role_id" type="checkbox" class="form-check-input"
												value="role-2">디자이너
										</div>
									</div>
									<div class="row">
				...
				<div class="row team_regist_row team_regist_row_btns">
					...
					<button id="registBtn" type="button" class="btn btn-md team_regist_btn_submit">등록하기</button>
				</div>
			</form>
		</div>
	</div>
